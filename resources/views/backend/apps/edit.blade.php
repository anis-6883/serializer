					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="url" name="ios_share_link" class="form-control" value="{{ $app->ios_share_link }}" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="url" name="facebook" class="form-control" value="{{ $app->facebook }}">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-control-label">{{ _lang('Telegram') }}</label>
								<input type="url" name="telegram" class="form-control" value="{{ $app->telegram }}">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<label class="form-control-label">{{ _lang('Youtube') }}</label>
								<input type="url" name="youtube" class="form-control" value="{{ $app->youtube }}">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
