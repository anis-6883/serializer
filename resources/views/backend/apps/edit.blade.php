...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card position-relative">
            <div class="card-body">
                <h3 class="font-weight-bold mb-4">{{ _lang('Edit') }} <span style="color: #dc3545">{{ _lang('App') }}</span></h3>
                <form method="post" autocomplete="off" action="{{ route('apps.update', $app->id) }}" enctype="multipart/form-data">
					@csrf
					@method('PUT')
					<div class="row">
						...
						<div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select id="select2" class="form-control" name="notification_type" data-selected="{{ $app->notification_type }}" required>
                        ...
                        <div class="col-md-6 d-none">
							<div class="form-group">
								...
								<input type="text" name="onesignal_app_id" class="form-control" value="{{ $app->onesignal_app_id }}">
							</div>
						</div>
						<div class="col-md-6 d-none">
							<div class="form-group">
								<label class="form-control-label">{{ _lang('One Signal Api Key') }}</label>
								<input type="text" name="onesignal_api_key" class="form-control" value="{{ $app->onesignal_api_key }}">
							</div>
						</div>
                        ...
                        <div class="col-md-6 d-none">
							<div class="form-group">
								...
								<input type="text" name="firebase_server_key" class="form-control" value="{{ $app->firebase_server_key }}">
							</div>
						</div>
						<div class="col-md-6 d-none">
							<div class="form-group">
								<label class="form-control-label">{{ _lang('Firebase Topics') }}</label>
								<input type="text" name="firebase_topics" class="form-control" value="{{ $app->firebase_topics }}">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control" name="app_publishing_control" data-selected="{{ $app->app_publishing_control }}" required>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control" name="ads_control" data-selected="{{ $app->ads_control }}" required>
                                    <option value="on">{{ _lang('On') }}</option>
                                    <option value="off">{{ _lang('Off') }}</option>
                                </select>
							</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control" name="ios_app_publishing_control" data-selected="{{ $app->ios_app_publishing_control }}" required>
                                    <option value="on">{{ _lang('On') }}</option>
                                    <option value="off">{{ _lang('Off') }}</option>
                                </select>
							</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control" name="ios_ads_control" data-selected="{{ $app->ios_ads_control }}" required>
                                    <option value="on">{{ _lang('On') }}</option>
                                    <option value="off">{{ _lang('Off') }}</option>
                                </select>
							</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="google_app_id" class="form-control" value="{{ $app->google_app_id }}" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-control-label">{{ _lang('Google AppOpen Ads ID') }}</label>
								<input type="text" name="google_appOpenAd_id" class="form-control" value="{{ $app->google_appOpenAd_id }}" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-control-label">{{ _lang('Google Banner Ads') }}</label>
								<input type="text" name="google_banner_ads" class="form-control" value="{{ $app->google_banner_ads }}" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-control-label">{{ _lang('Google Interstitial Ads') }}</label>
								<input type="text" name="google_interstitial_ads" class="form-control" value="{{ $app->google_interstitial_ads }}" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label" id="block__country__label">{{ _lang('Enable Countries') }}</label>
								<select id="select3" class="form-control" data-selected="{{ $app->enable_countries }}" name="enable_countries[]" multiple required>
									{{ get_country_list() }}
								</select>
							</div>
						</div>
						...
						<div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="required_app_enable" data-selected="{{ $app->required_app_enable }}" required>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="required_app_id" class="form-control" value="{{ $app->required_app_id }}" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-control-label">{{ _lang('App Url') }}</label>
								<input type="url" name="required_app_url" class="form-control" value="{{ $app->required_app_url }}" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-control-label">{{ _lang('App Name') }}</label>
								<input type="text" name="required_app_name" class="form-control" value="{{ $app->required_app_name }}" required>
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<label class="form-control-label">{{ _lang('Description') }}</label>
								<textarea name="required_app_desc" class="form-control" rows="5">{{ $app->required_app_desc }}</textarea>
							</div>
						</div>
						<div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">{{ _lang('Logo') }}</label>
                                <input type="file" class="form-control dropify" name="required_app_logo" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG" data-default-file="{{ asset($app->required_app_logo) }}">
                            </div>
                        </div>
						<div class="col-md-12">
							<div class="form-group">
