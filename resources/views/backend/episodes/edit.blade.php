...
<form method="POST" autocomplete="off" action="{{ route('episodes.update', $episode->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card position-relative">
                <div class="card-body">
                    <h3 class="font-weight-bold mb-4">{{ _lang('Edit') }} <span style="color: #dc3545">{{ _lang('Episode') }}</span></h3>
                    <div class="row">

                        @php
                            $checked = '';
                            if(counter('episode_apps', ['episode_id' => $episode->id]) == counter('apps', ['status' => 1])){
                                $checked = 'checked';
                            }
                        @endphp
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                @foreach (App\Models\AppModel::where('status', 1)->get() as $app)
                                    @php
                                        $checked = '';
                                        if(App\Models\EpisodeApp::where('app_id', $app->id)->where('episode_id', $episode->id)->exists()){
                                            $checked = 'checked';
                                        }
                                    @endphp
                                    <div class="form-check flex-shrink-0" style="width: 150px">
                            ...
                            <div class="form-group">
                                ...
                                <select id="select2" class="form-control" name="serial_id" required>
                                    ...
                                    @foreach ($serials as $serial)
                                        <option value="{{ $serial->id }}" {{ $serial->id === $episode->serial_id ? "selected": "" }}>{{ _lang($serial->serial_name) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="cover_image_type" data-selected="{{ $episode->cover_image_type }}" required>
                        ...
                        <div class="col-md-12 d-none">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cover_url" value="{{ $episode->cover_url }}" >
                            </div>
                        </div>
                        <div class="col-md-12 {{ ($episode->cover_image_type == 'image') ? '' : ' d-none'}}">
                            <div class="form-group">
                                <label class="control-label">{{ _lang('Image') }}</label>
                                <input type="file" class="form-control dropify" name="cover_image" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG" data-default-file="{{ $episode->cover_image ? asset($episode->cover_image) : '' }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="datepicker" type="text" name="episode_date" class="form-control" value="{{ $episode->episode_date }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status" data-selected="{{ $episode->status }}" required>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-right">
                                            <button style="padding: 1px 8px;" type="button" class="btn btn-danger btn-sm remove-row">-</button>
                                        </div>
                                        ...
                                        <div class="row innerContainer">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="resulation[{{ $key }}]" data-selected="{{ $streaming_source->resulation }}" required>
                                                        <option value="">{{ _lang('Select One') }}</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control stream_type" name="stream_type[{{ $key }}]" data-selected="{{ $streaming_source->stream_type }}" required>
                                                        <option value="">{{ _lang('Select One') }}</option>
                                            ...
                                            @if ( $streaming_source->stream_type == 'restricted')
                                                ...
                                                @foreach (json_decode($streaming_source->headers) as $key2 => $value)
                                                    <div class="row field-group2 restricted mx-4 mb-3 {{ $streaming_source->stream_type != 'restricted' ? 'd-none' : '' }}" style="width: 100%">
                                                        <div class="col-md-12">
                                            ...
                                            @else
                                                <div class="row field-group2 restricted mx-4 mb-3 d-none" style="width: 100%">
                                                    <div class="col-md-12">
                                                        <div class="card" style="background: #F5F7FF">
                                                            <div class="card-body">
                                                                <div class="text-right">
                                            ...
                                            <div class="col-md-11 text-right restricted {{ $streaming_source->stream_type != 'restricted' ? 'd-none' : '' }} m-auto">
                                                <div class="form-group">
...
<script>
    ...
    @if($episode->cover_image_type == 'url')
        ...
        $('.cover_image').html('<img src="{{ $episode->cover_url }}" style="width: 150px; border-radius: 10px;">');
    @elseif($episode->cover_image_type == 'image')
